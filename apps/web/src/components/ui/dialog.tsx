...
export function DialogContent({
  ...
  return (
    <BaseDialog.Portal>
      <BaseDialog.Backdrop className="fixed inset-0 z-(--z-modal) bg-black/40 backdrop-blur-sm transition-all duration-200 data-[ending-style]:opacity-0 data-[starting-style]:opacity-0 supports-[-webkit-touch-callout:none]:absolute" />
      <BaseDialog.Popup
        className={cn(
          // Desktop: centered modal
          "fixed z-(--z-modal) rounded-2xl bg-white shadow-elevated outline-0 focus-visible:outline-2 focus-visible:outline-accent-500 focus-visible:outline-offset-2 transition-all duration-200 data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[starting-style]:scale-95 data-[starting-style]:opacity-0",
