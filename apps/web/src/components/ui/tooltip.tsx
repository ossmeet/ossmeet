  ...
  return (
    <BaseTooltip.Root>
      ...
      <BaseTooltip.Portal>
        ...
        >
          <BaseTooltip.Popup className="pointer-events-none max-w-48 rounded-lg bg-neutral-900 px-2.5 py-1.5 text-center text-xs leading-4 font-medium text-white shadow-lg origin-(--transform-origin) transition-[transform,scale,opacity] data-[instant]:transition-none data-[ending-style]:scale-90 data-[ending-style]:opacity-0 data-[starting-style]:scale-90 data-[starting-style]:opacity-0">
            {content}
          </BaseTooltip.Popup>
        </BaseTooltip.Positioner>
      </BaseTooltip.Portal>
