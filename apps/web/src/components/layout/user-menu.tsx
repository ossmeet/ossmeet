...
export function UserMenu({ user, onLogout }: UserMenuProps) {
  return (
    <MenuRoot>
      <MenuTrigger className="group flex items-center gap-2.5 rounded-xl p-1.5 pr-2 transition-all duration-200 hover:bg-stone-100/80 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-accent-500/30 border border-transparent hover:border-stone-200/60">
      ...
      <MenuContent side="bottom" align="end" sideOffset={8} className="w-60 p-2">
        ...
        <MenuItem
          onClick={onLogout}
          className="mt-1 text-danger-600 data-[highlighted]:bg-danger-50 data-[highlighted]:text-danger-700"
        >
          <LogOut size={16} />
          Sign out
        </MenuItem>
