...
import { sessionsListQueryOptions, linkedAccountsQueryOptions, passkeysQueryOptions } from "@/queries/settings";
...
export const Route = createFileRoute("/_authed/settings/")({
  ...
  loader: ({ context }) =>
    Promise.all([
      ...
      context.queryClient.prefetchQuery(passkeysQueryOptions()),
    ]),
});
