/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 59717cf84ed4f4e5c2393c0a6c47020c)
// Runtime types generated with workerd@1.20260415.1 2026-03-29 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		UPTIMEROBOT_MONITOR_LIVEKIT_ID: string;
		UPTIMEROBOT_MONITOR_WHITEBOARD_ID: string;
		PADDLE_API_KEY: string;
		PADDLE_WEBHOOK_SECRET: string;
		PADDLE_ENVIRONMENT: string;
		VITE_PADDLE_CLIENT_TOKEN: string;
		PADDLE_PRICE_ID_PRO: string;
		PADDLE_PRICE_ID_ORG: string;
	}
}
