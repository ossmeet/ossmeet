...
export const ID_PREFIX = {
  ...
  MEMBER: "mbr_",
  MEETING_ADMISSION: "mad_",
  MEETING_LIVEKIT_PRESENCE: "mlp_",
  MEETING_EVENT: "mev_",
  ACCOUNT: "acc_",
  TRANSCRIPT: "trn_",
...
export const MEETING_ADMISSION_SUBJECT_TYPES = ["user", "guest"] as const;
export const MEETING_ADMISSION_STATUSES = [
  "awaiting_approval",
  "approved",
  "denied",
  "revoked",
] as const;
export const MEETING_LIVEKIT_PRESENCE_STATUSES = [
  "token_issued",
  "connected",
  "disconnected",
  "aborted",
